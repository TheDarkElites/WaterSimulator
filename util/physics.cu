...
/* Conservative Force */
__device__ float d_weight_c(float r) {
    return 1- (r/RC);
}
...
/* Dissipative Force */
__device__ float d_weight_d(float r) {
...
__device__ float d_weight_r(float r) {
    return 1- (r/RC);
}
